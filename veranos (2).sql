...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 05-06-2023 a las 22:32:28
...
(93, 2203024384, '2203024384_INE.pdf', '2203024384_CURP_MATA010310HDFLPNA3.pdf', '2203024384_comprobante.pdf', '2203024384_comprobanteVigenciaDerechos09130167449.pdf', '2203024384_CV_2023.pdf', '2203024384_Comprobante academico ultimo promedio.pdf', '2203024384_CamScanner 02-06-2023 22.04.pdf', '2203024384_FORMATO_DE_PAGP.pdf', '2203024384_2023-06-02.pdf', '2203024384_Formato de postulación.pdf');
...
(81, 26, 'Derecho', 4, 'Jurídico', 'Apoyo con las actividades de litigio interno e internacional.', '', '', '', 2, 'N/A', '05-06-2023 11:17:59'),
...
INSERT INTO `estudiantes` (`id`, `nombres`, `a_paterno`, `a_materno`, `matricula`, `licenciatura`, `creditos`, `edad`, `sexo`, `correo`, `telefono`, `cretate`, `estatus`) VALUES
(28, 'ANDRES ALEXIS', 'MALFAVAUN', 'TAPIA', '2203024384', 'Tecnologías y Sistemas de Información', 183, 22, 'Masculino', 'ANDRES.MALFAVAUN@CUA.UAM.MX', 5637269723, '05-06-2023 11:39:19', 1),
(31, 'ANDRES', 'MELGAR', ' ', '2154215421', 'Administracion', 152, 23, 'Masculino', 'CORREO@CORREO.COM', 5555555555, '05-06-2023 14:33:08', 1);
...
(26, 'IDHEAS, Litigio Estratégico en derechos humanos, A.C.', 'Calle 21, 77. San Pedro de Los Pinos. Benito Juárez, CDMX, 03800.', '05-06-2023 11:11:46', 1);
...
--
ALTER TABLE `espacio_disponible`
  MODIFY `id_espacio` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=194;
...
--
ALTER TABLE `organizacion`
  MODIFY `id_org` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=35;
